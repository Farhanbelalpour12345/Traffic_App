...
class GasolineFilter extends StatefulWidget {
  const GasolineFilter({Key? key}) : super(key: key);

  @override
  _GasolineFilterState createState() => _GasolineFilterState();
}

class _GasolineFilterState extends State<GasolineFilter> {
